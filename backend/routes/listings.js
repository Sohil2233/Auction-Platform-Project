...
router.post("/", auth, async (req, res) => {
  try {
    const { title, description, startPrice, startTime, endTime, image, category, condition } = req.body;
...
router.put("/:id", auth, async (req, res) => {
  try {
    const { title, description, startPrice, startTime, endTime, category, condition } = req.body;
    ...
    const update = { title, description, startPrice, startTime, endTime };
